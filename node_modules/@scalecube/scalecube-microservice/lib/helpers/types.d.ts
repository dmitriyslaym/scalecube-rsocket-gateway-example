...
export declare type CreateLocalRegistry = () => LocalRegistry;
...
export declare type GetUpdatedLocalRegistry = (options: GetUpdatedLocalRegistryOptions) => LocalRegistryMap;
export interface GetUpdatedLocalRegistryOptions {
    localRegistryMap: LocalRegistryMap;
    references: Reference[];
}
export declare type GetReferenceFromServices = (options: AvailableServices) => Reference[] | [];
export declare type CreateRemoteRegistry = () => RemoteRegistry;
