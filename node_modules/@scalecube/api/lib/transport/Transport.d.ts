...
export declare type ServerTransport = (options: ServerTransportOptions) => ServerStop;
 ...
 */
export declare type ServerStop = () => void;
export declare type TLogger = (msg: any, type: 'warn' | 'log') => void;
export declare type TDestroy = (options: TDestroyOptions) => void;
